    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        ***************************************/
         ...
         for (int i = 0; i  < sensor_fusion.size(); ++i)
         {
            ...
            if (((check_car_s -  car_s) > -25.0) && (( check_car_s - car_s) < 40.0)) 
            {
              ...
              {
               too_close = true;
               front_car_speed = check_speed * 2.24;  //from ,s to mph               
              }
          ...
          //  std::cout <<"too_close " << too_close << " right_ln_avl " << right_ln_avl <<" left_ln_avl " << left_ln_avl <<std::endl;  // for debug
        ...
        ***************************************/
          ...
          case turn_left:
            lane -= 1;
            std::cout <<" action: turn_left "<< std::endl ;
            break;
          case turn_right:
            lane += 1;
            std::cout <<" action: turn_right "<< std::endl ;
            break;
          case follow:
            if (ref_vel > front_car_speed)
              ref_vel -= 0.224;
            std::cout <<" action: follow   front vehicle  Target speed:"<<  front_car_speed <<std::endl ;
            break;
          }

           // std::cout <<" mode "<< action ;   // for debug
          // std::cout <<" ref_vel "<< ref_vel << std::endl<<std::endl;
